...
async function setSharedBdDevActiveStatus(bdDev_id, active, accessLevel) {
    try {
        const queryCmd = `UPDATE ${devTableName} SET active = ${active}, accessLevel = ${accessLevel} WHERE bdDev_id = ${bdDev_id};`;
